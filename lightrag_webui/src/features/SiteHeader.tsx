  ...
  return (
    <div className="flex h-8 self-center">
      <TabsList className="h-full gap-2">
        ...
        <NavigationTab value="legal-documents" currentTab={currentTab}>
          {t('header.legalDocuments', 'Văn bản PL')}
        </NavigationTab>
        <NavigationTab value="legal-chat" currentTab={currentTab}>
          {t('header.legalChat', 'Tư Vấn PL')}
        </NavigationTab>
      </TabsList>
    </div>
  )
