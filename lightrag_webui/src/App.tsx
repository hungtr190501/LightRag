...
import EvalDashboard from '@/features/EvalDashboard'
import LegalDocumentManager from '@/features/LegalDocumentManager'
import LegalChat from '@/features/LegalChat'
          ...
          <main className="flex h-screen w-screen overflow-hidden">
            ...
            >
              ...
              <div className="relative grow">
                ...
                <TabsContent value="legal-documents" className="absolute top-0 right-0 bottom-0 left-0 overflow-auto">
                  <LegalDocumentManager />
                </TabsContent>
                <TabsContent value="legal-chat" className="absolute top-0 right-0 bottom-0 left-0 overflow-hidden">
                  <LegalChat />
                </TabsContent>
              </div>
            </Tabs>
